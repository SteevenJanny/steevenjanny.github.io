...
const Plugin = {
	 ...
	 *
	 * @param {Reveal} reveal the reveal.src_js instance
	 */
	init: function( reveal ) {

		// Read the src_plugin config options and provide fallbacks
