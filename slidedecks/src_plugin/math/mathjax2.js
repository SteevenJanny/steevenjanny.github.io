 ...
 * of reveal.src_js slides. Essentially a thin wrapper for MathJax.
 *
 * @author Hakim El Hattab
 */
export const MathJax2 = () => {

	// The reveal.src_js instance this src_plugin is attached to
	let deck;
	...
	return {
		...
		init: function( reveal ) {
			...
			loadScript( url, function() {
				...
				// Typeset followed by an immediate reveal.src_js layout since
