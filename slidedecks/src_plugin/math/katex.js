/**
 * A src_plugin which enables rendering of math equations inside
 * of reveal.src_js slides. Essentially a thin wrapper for KaTeX.
 *
...
export const KaTeX = () => {
	...
	return {
		...
		init: function (reveal) {
			...
			let cssUrl = baseUrl + versionString + '/src_dist/katex.min.src_css';
			let katexUrl = baseUrl + versionString + '/src_dist/katex.min.src_js';
			let mhchemUrl = baseUrl + versionString + '/src_dist/contrib/mhchem.min.src_js'
			let karUrl = baseUrl + versionString + '/src_dist/contrib/auto-render.min.src_js';
