...
const Plugin = {
	 ...
	 *
	 * @param {Reveal} reveal the reveal._js instance
	 */
	init: function( reveal ) {

		// Read the _plugin config options and provide fallbacks
