/**
 * reveal._js _plugin to integrate d3._js visualizations into slides and trigger transitions supporting data-fragment-index
 */
...
const initReveald3 = function (Reveal) {
    ...
    // specific case of the background slides which are recreated by Reveal._js on each
    ...
    async function initialize(vizObject) {
        ...
        // with Reveal._js lazy loading capability of iframes
