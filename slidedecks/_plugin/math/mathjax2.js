 ...
 * of reveal._js slides. Essentially a thin wrapper for MathJax.
 *
 * @author Hakim El Hattab
 */
export const MathJax2 = () => {

	// The reveal._js instance this _plugin is attached to
	let deck;
	...
	return {
		...
		init: function( reveal ) {
			...
			loadScript( url, function() {
				...
				// Typeset followed by an immediate reveal._js layout since
