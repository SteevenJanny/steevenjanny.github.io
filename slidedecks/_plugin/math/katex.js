/**
 * A _plugin which enables rendering of math equations inside
 * of reveal._js slides. Essentially a thin wrapper for KaTeX.
 *
...
export const KaTeX = () => {
	...
	return {
		...
		init: function (reveal) {
			...
			let cssUrl = baseUrl + versionString + '/_dist/katex.min._css';
			let katexUrl = baseUrl + versionString + '/_dist/katex.min._js';
			let mhchemUrl = baseUrl + versionString + '/_dist/contrib/mhchem.min._js'
			let karUrl = baseUrl + versionString + '/_dist/contrib/auto-render.min._js';
