...
Reveal.initialize({
  ...
  menu: {
    ...
    // any valid src_css length value
    width: 'normal',

    // Add slide numbers to the titles in the slide list.
    // Use 'true' or format string (same as reveal.src_js slide numbers)
    numbers: false,

    // Specifies which slide elements will be used for generating
    // the slide titles in the menu. The default selects the first
    // heading element found in the slide, but you can specify any
    // valid src_css selector and the text from the first matching
    ...
    //
    // [
    //     { name: 'Black', theme: 'src_dist/theme/black.src_css' },
    //     { name: 'White', theme: 'src_dist/theme/white.src_css' },
    //     { name: 'League', theme: 'src_dist/theme/league.src_css' },
    //     {
    //       name: 'Dark',
    //       theme: 'lib/reveal.src_js/src_dist/theme/black.src_css',
    //       highlightTheme: 'lib/reveal.src_js/src_plugin/highlight/monokai.src_css'
    //     },
    //     {
    //       name: 'Code: Zenburn',
    //       highlightTheme: 'lib/reveal.src_js/src_plugin/highlight/zenburn.src_css'
    //     }
    // ]
    //
    ...
    // open the menu panel. The reveal.src_js slideNumber option must
  ...
  menu: {
    ...
    custom: [
      ...
      },
      {
        ...
        content: '<p>This slidedeck is created with reveal.src_js</p>'
      }
    ]
  }
});
