...
export function create(container, context) {
    ...
    const graph = d3.select(container).append("svg")
    ...
    graph.append("foreignObject")
        ...
        .attr("y", height / 2 - 2 * p.block_height / 3 - p.shift_up - 5)
    ...
    closed_dyn.append("foreignObject")
        .attr("x", width / 4 - p.block_width / 2)
        .attr("y", height / 2 - p.block_height / 2 - p.shift_up + 5)
    ...
    open_dyn.append("foreignObject")
        .attr("x", width / 4 - p.block_width / 2 - p.shift_right )
        .attr("y", height / 2 - p.block_height / 2 - p.shift_up + 9)
        .attr("font-size", "1.3rem")
        .attr("width", p.block_width)
        .attr("height", p.block_height)
    ...
    open_dyn.append("foreignObject")
        ...
        .attr("y", height / 2 - p.block_height / 2 + p.shift_down + 10)
        .attr("font-size", "1.3rem")
