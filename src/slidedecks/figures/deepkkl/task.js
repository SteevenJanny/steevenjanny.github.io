...
export function create(container, context) {
    ...
    var graph_lorenz = d3.select(container).append("svg")
    ...
    graph_lorenz.append("foreignObject")
        ...
        .style("text-align", "center")
        .style("font-size", "20px")
        .html("<i>Sensor $y = {\\color{#277C9D} h}(\\mathbf{s})$</i>");
    ...
    graph_lorenz.append("foreignObject")
        ...
        .style("text-align", "center")
        .style("font-size", "20px")
        .html("<i>Dynamics $\\dot{\\mathbf{s}} = {\\color{#277C9D} f}(\\mathbf{s})$</i>");
    ...
    var rand = d3.randomNormal(0, 0.5)
    ...
    return {
        steps:[
            {
                index: 0,
                forward: toggle_observation_on,
                backward: toggle_observation_off,
            },
            {
                index: 1,
                forward: toggle_box_on,
                backward: toggle_box_off,
            }
        ],
        onSlideEnter: () =>{
            toggle_observation_off()
            toggle_box_off()
        },
        onSlideLeave: () =>{
            toggle_observation_off()
