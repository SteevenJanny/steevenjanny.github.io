...
export function create(container, context) {
    var margin = {top: 40, right: 50, bottom: 45, left: 50, width:1000, height:220};
    ...
    var graph_width = margin.width / 4;
    ...
    // Load json
    d3.json("assets/eagle/results/data.json").then(function (data) {
        ...
        var yScale_error = d3.scaleLinear()
            .domain([error_max, 0])
            .range([margin.top, margin.height - margin.bottom]);
