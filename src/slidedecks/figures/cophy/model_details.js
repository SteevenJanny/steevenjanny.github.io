...
export function create(container, context) {
    ...
    var graph_model = d3.select(container).append("svg")
    ...
    const cody_width = 600
    const cody_height = (yScale_model(1) - yScale_model(0))
    ...
    cf_module.append("rect")
        .attr("x", xScale_model(0.5) - blockWidth/2)
        .attr("y", yScale_model(0) + 10)
    ...
    dynamics_module.append("rect")
        ...
        .attr("y", yScale_model(0) + cody_height - 110)
    ...
    graph_model.append("foreignObject")
        ...
        .attr("height", imgSize)
        .append("xhtml:video")
        .attr("src", "assets/cophy/model/AB_seg.mp4")
        .attr("width", imgSize)
        .attr("autoplay", true)
        .attr("loop", true)
    ...
    graph_model.append("foreignObject")
        ...
        .attr("height", imgSize)
        .append("xhtml:img")
        .attr("src", "assets/cophy/model/C_seg.jpg")
        .attr("width", imgSize)
        .style("border", "solid 1px black")
        .style("margin", 0);
    ...
    graph_model.append("foreignObject")
        .attr("x", xScale_model(1) - imgSize)
        .attr("y", yScale_model(0.5) - imgSize/2)
        .attr("width", imgSize)
        .attr("height", imgSize)
        .append("xhtml:video")
        .attr("src", "assets/cophy/model/CD_seg.mp4")
        .attr("width", imgSize)
        .attr("autoplay", true)
        .attr("loop", true)
        .style("border", "solid 1px black");
    ...
    cf_edges.selectAll("line")
        ...
        .append("line")
        .attr("x1", function (d) {
            return d.x1 + blocksize / 2
        })
        .attr("y1", function (d) {
            return d.y1 + blocksize / 2
        })
        .attr("x2", function (d) {
            return d.x2 + blocksize / 2
        })
        .attr("y2", function (d) {
            return d.y2 + blocksize / 2
        })
        .attr("stroke-width", 2)
        .attr("stroke", "#525252")
